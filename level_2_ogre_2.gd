...
var level_1_patrol_points = PackedVector3Array([Vector3(32.301, 0.595, -3.079), Vector3(28.007, 0.595, -3.079), Vector3(28.007, 0.595, 3.88), Vector3(32.301, 0.595, 3.88)])
