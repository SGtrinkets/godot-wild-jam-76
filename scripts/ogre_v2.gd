...
var level_1_patrol_points = PackedVector3Array([Vector3(25.62, 0.5, -0.87), Vector3(25.62, 0.5, 3.654), Vector3(32.86, 0.5, 3.654), Vector3(32.86, 0.5, -0.75)])
...
@onready var ticking_sound: AudioStreamPlayer3D = $ogre/ticking_sound
...
func wandering():
	...
	var target_point = level_1_patrol_points[i]
...
func _play_patrol_animation():
	...
	i = (i + 1) % level_1_patrol_points.size()
	
	var next_point = level_1_patrol_points[i]
